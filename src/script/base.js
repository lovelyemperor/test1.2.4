...
//----------------------------- Loading 前后逻辑处理 ----------------------------------//
    ...
    this.loadingAfterInit = function () {
        ...
        // 设置菜单个人简介头像
        var blogAvatar = window.cnblogsConfig.blogAvatar ? window.cnblogsConfig.blogAvatar : 'https://gitee.com/xuqicheng/Cnblogs-Theme-SimpleMemory/raw/master/img/webp/default_avatar.webp';
...
//=================== 逻辑处理：页面公共处理
    ...
    this.addFooter = function() {
        ...
        function init_t1() {
            ...
            $('.footer-image').css({
                'background': 'url(https://gitee.com/xuqicheng/Cnblogs-Theme-SimpleMemory/raw/master/img/webp/footer.webp) no-repeat 50%',
                'height': '368px',
                'z-index': '1',
                'position': 'absolute',
                'bottom': '100px',
            ...
            commentList.each(function (i) {
                ...
                if (p.length > 0) {
                    ...
                    if (op.length > 0 && op.text() != '') {
                        ...
                        html += '<img class="comment-avatar" src="https://gitee.com/xuqicheng/Cnblogs-Theme-SimpleMemory/raw/master/img/webp/default_avatar.webp"/>';
                    }
