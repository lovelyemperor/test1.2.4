...
if (initCheck()) {
    ...
    window.cnblogsConfigDefault = {
        ...
        homeTopImg: [
            "https://gitee.com/xuqicheng/Cnblogs-Theme-SimpleMemory/raw/master/img/webp/home_top_bg.webp"
        ],
        homeBannerText: "",
        homeBannerTextType: "jinrishici",
        essayTopImg: [
            "https://gitee.com/xuqicheng/Cnblogs-Theme-SimpleMemory/raw/master/img/webp/nothome_top_bg.webp"
        ],
...
function getVersionConfig() {
    ...
    if (window.cnblogsConfig.GhUserName === 'BNDong') {
        ...
        $.getScript('https://gitee.com/xuqicheng/Cnblogs-Theme-SimpleMemory/raw/master/version.js', function () {
            setConfVersion();
        });

    } else {
        var url = 'https://cdn.jsdelivr.net/gh/'+(window.cnblogsConfig.GhUserName)+'/'+(window.cnblogsConfig.GhRepositories)+'@'+(window.cnblogsConfig.GhVersions)+'/'+'version.conf';
